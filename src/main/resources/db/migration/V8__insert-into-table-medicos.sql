DELETE FROM `vollmed_api2`.`medicos`;


INSERT INTO `vollmed_api2`.`medicos` (`id`, `nombre`, `email`, `documento`, `especialidad`, `calle`, `distrito`, `complemento`, `numero`, `ciudad`, `telefono`, `activo`)
